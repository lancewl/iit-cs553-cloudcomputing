...
class IO_Helper{
    public:
        ...
        int getNumChunks(); // get the total number of chunks
        
        int currentChunkIndex; // 0 means working on chunk0 and chunk1. 2 mean working on chunk2 and chunk3.
        
        // ready up two queues, chunkAQ, chunkBQ
        // queue access functions
        void chunkQInit(); // initialize the chunk queues
